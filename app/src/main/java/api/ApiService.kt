...
interface ApiService {
    ...
    // EXISTING: For manual control with specific door_id
    ...
    // NEW: For auto-assignment (no door_id in path)
    ...
    // End session (make available + open door)
